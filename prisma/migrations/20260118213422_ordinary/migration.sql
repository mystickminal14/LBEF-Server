...
-- AlterTable
ALTER TABLE `permission` MODIFY `name` ENUM('USERS', 'COURSES', 'TEAMS', 'ALUMNI', 'PLANNER_COURSE', 'NEWS', 'ALMUNI_FORM', 'JOURNALS', 'EDITORIAL_BOARD', 'CONNECT', 'GALLERY', 'SCHOLARSHIP', 'NOTICE', 'CONTACT', 'HOLIDAY', 'RECOGNITION', 'ACHIEVEMENT', 'INTAKE', 'DOCUMENTS', 'ACADEMIC_PLANNER', 'FEE_PLANNER', 'DOWNLOADS') NOT NULL;
