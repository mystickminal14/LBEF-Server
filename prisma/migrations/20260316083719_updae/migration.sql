/*
  ...
  - You are about to alter the column `volume` on the `lbefconnect` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
  - You are about to alter the column `issue` on the `lbefconnect` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
...
-- AlterTable
ALTER TABLE `lbefconnect` MODIFY `volume` INTEGER NULL,
    MODIFY `issue` INTEGER NULL;
