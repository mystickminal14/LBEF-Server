/*
  ...
  - Added the required column `category` to the `CourseDetailBlock` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `coursedetailblock` ADD COLUMN `category` ENUM('COURSE_STRUCTURE', 'CAREER_OPTIONS', 'FEE_STRUCTURE', 'ELIGIBULITY_CRITERIA') NOT NULL;
