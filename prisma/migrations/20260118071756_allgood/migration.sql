...
-- DropIndex
DROP INDEX `FeePlanner_feeYearId_plannerCourseId_idx` ON `feeplanner`;
...
-- AlterTable
ALTER TABLE `feeplanner` ADD COLUMN `course` VARCHAR(191) NULL,
    MODIFY `plannerCourseId` INTEGER NULL;

-- CreateIndex
CREATE INDEX `FeePlanner_feeYearId_idx` ON `FeePlanner`(`feeYearId`);
