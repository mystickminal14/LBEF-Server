/*
  ...
  - Added the required column `month` to the `GalleryType` table without a default value. This is not possible if the table is not empty.
  - Added the required column `year` to the `GalleryType` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `gallerytype` ADD COLUMN `day` VARCHAR(191) NULL,
