...
CREATE TABLE `Permission` (
    ...
    `name` ENUM('USERS', 'COURSES', 'TEAMS', 'ALUMNI', 'NEWS', 'JOURNALS', 'EDITORIAL_BOARD', 'CONNECT', 'GALLERY', 'NOTICE', 'CONTACT', 'HOLIDAY', 'RECOGNITION', 'ACHIEVEMENT', 'INTAKE', 'DOCUMENTS', 'ACADEMIC_PLANNER', 'FEE_PLANNER', 'DOWNLOADS') NOT NULL,
