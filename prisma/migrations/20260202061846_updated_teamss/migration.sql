/*
  ...
  - Added the required column `status` to the `ScholarshipSchedule` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `scholarshipschedule` ADD COLUMN `status` ENUM('OPEN', 'CLOSED') NOT NULL;
