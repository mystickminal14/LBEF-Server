/*
  ...
  - Made the column `academicYearId` on table `academicplanner` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `academicplanner` MODIFY `academicYearId` INTEGER NOT NULL;
